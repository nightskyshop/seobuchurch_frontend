    ...
    <div>
      ...
      <div className={styles.vision__declarate}>
        ...
        <p className={styles.declarate__content}>
          ...
          진리로 예배하며, <br />
          <span className={styles.underline}>사람을 사랑</span>하여 영혼
          구원하여 제자를 삼고, <br />
          성령의 풍성한 교제를 누리며, 하나님의 말씀을 가르쳐 지키게 하며,{" "}
          <br />
          하나님께 받은 사람으로 이웃을 섬기는 <span>한 가족 공동체</span>
          입니다.
        </p>
      </div>
      ...
      <div className={styles.vision__content}>
        <p>
          ...
          예수 그리스도의 십자가는 위로는 하나님과의 관계를 회복시키고, <br />
          옆으로는 이웃과의 관계를 회복시켰습니다. <br />
        </p>

        <p>
          성경은 예수그리스도 안에 있는 구원의 길을 우리에게 보여줍니다. <br />
          그리고 구원의 은혜를 받은 우리가 하나님의 백성으로서 <br />
          어떤 삶을 살아가야 하는지 그 길을 보여줍니다 (딤후3:15~17). <br />
          <span>
      ...
      <div className={styles.vision__number}>
        ...
        <div className={styles.number__content}>
          ...
          <p>
            ...
            <br />
            그리고 하나님의 사랑을 아는 만큼 하나님의 사랑을 닮아 <br />
            하나님을 사랑하고 사람을 사랑하는 삶을 살 수 있게 됩니다. <br />
            그러므로 성령 충만한 예배, 감동과 은혜가 있는 예배, <br />
            하나님의 임재 속에 헌신과 결단이 있는 예배를 통해 하나님의 교회를
            세워가십니다.
          </p>
        </div>
        ...
        <div className={styles.number__content}>
          ...
          <p>
            ...
            <br />
            하나님 사랑, 사람 사랑의 비전 실천사항들이 <br />
            성도들의 개개인의 삶 속에 잘 적용되기 위해서 건강한 소그룹 모임이
            필수적입니다. <br />
            건강한 소그룹 모임 안에서 사랑과 선행을 격려하고, <br />
            서로의 문제를 위해 뜨겁게 기도해 주고, 하나님의 위로와 소망을
            전하며, <br />
            함께 기뻐하고 함께 슬퍼하는 건강한 나눔이 있을 때에 <br />
            우리의 신앙은 함께 자라갈 수 있습니다.
          </p>
        </div>
        ...
        <div className={styles.number__content}>
          ...
          <p>
            ...
            지향합니다. <br />
            매주 설교 말씀을 붙들고 기도하며 삶 속에 적용하고, <br />
            소그룹 훈련을 통해서 삶과 인격의 변화가 이루어질 수 있도록 할 때{" "}
            <br />
            하나님 사랑, 사람 사랑을 비전을 이루어 갈 수 있습니다.
          </p>
        </div>
      </div>

      <p className={styles.vision__conclusion}>
        마지막으로 이 세가지 축이 균형잡힌 모습으로 잘 돌아가도록 <br />
        윤활유 역할을 하는 것이 목회자의 리더십입니다. <br />
        예수님께서 제자들읠 발을 씻기심같이 섬기는 리더십, 자기 희생의
        리더십으로 <br />온 교회가 하나님 사랑, 사람 사랑의 비전을 이루어 갈
        있도록 섬기는 것이 <br />
        비전을 이루어가는 윤활유 역할을 합니다.
      </p>
    </div>
  );
}
